...
const char* ssid = "CLAY WIRELESS"; //type your WIFI information inside the quotes
const char* password = "Clayexcavating";
const char* mqtt_server = "m15.cloudmqtt.com";
const char* mqtt_username = "willclayAdmin";
const char* mqtt_password = "team1750";
const int mqtt_port = 13930;



/**************************** FOR OTA **************************************************/
#define SENSORNAME "porch" //change this to whatever you want to call your device
#define OTApassword "team1750" //the password you will need to enter to upload remotely via the ArduinoIDE
int OTAport = 8266;



/************* MQTT TOPICS (change these topics as you wish)  **************************/
const char* light_state_topic = "clay/porch";
const char* light_set_topic = "clay/porch/set";
